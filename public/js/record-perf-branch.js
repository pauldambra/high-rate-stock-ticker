...
function record(options = {}) {
  ...
  wrappedEmit = (r2, isCheckout) => {
    ...
    if (((_a2 = mutationBuffers[0]) == null ? void 0 : _a2.isFrozen()) && e2.type !== EventType.FullSnapshot && !(e2.type === EventType.IncrementalSnapshot && [
...
// Expose rrweb globally for script tag usage
window.rrweb = { record };
